...
% What the general goal of our group was to achieve this week
\paragraph{General:}
This week we went into more detail with both the linear regression and the gravitational model, trying to determine which changes to the settings of the sbi causes which changes to the results.
